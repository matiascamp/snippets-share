...
const CustomEditor = () => {
    ...
    return (
        <div className="flex flex-col w-md sm:w-xl md:w-2xl lg:w-3xl xl:w-4xl h-200 rounded-xl py-4 justify-between mt-8" style={{ backgroundColor: theme === 'vs-dark' ? '#1e1e1e' : '#ffffff' }}>
            <Editor
            className=""
                theme={theme}
                height="90%"
